...
public class DataGetter {
	 ...
	 */
	public static void getTimeWheater(String lon, String lat, int offsetdia, int offsethour) throws Exception {
		...
		if (offsethour == 0) {
			...
			sky_cover="OVC";
			if(clou<0.7)sky_cover="BKN";
			if(clou<0.5)sky_cover="SCT";
			if(clou<0.25)sky_cover="FEW";
			if(clou<0.1)sky_cover="SKC";
			...
			if(hourly.hours() <offsethour)offsethour=hourly.hours()-1;
